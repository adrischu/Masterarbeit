 ...
 get header() {
  ...
  return [
   ...
   },
   {
    ...
    inputType: "select",
    selectListKeys: [this.Koordinatensystem, "lokal", "global"],
    selectListValues: [this.Koordinatensystem, "lokal", "global"],
   },
   {
    title: "Richtung",
    value: this.Richtung,
    inputType: "select",
    selectListKeys: [this.Richtung, "x", "z"],
    selectListValues: [this.Richtung, "x", "z"],
   },
   {
    title: "Projektion",
